  ...
  return (
    <>
     ...
     <div className='container lg:w-[80%] w-[90%] mx-auto py-10 flex flex-col gap-5'>
      ...
      <div className="flex flex-col lg:flex-row justify-between gap-2 lg:w-[80%]">

         <div className='bg-pink-300 shadow-md rounded-lg p-4 lg:w-xs flex flex-col items-center gap-1 '>

          <div className="bg-white w-fit p-4 rounded-full text-pink-500">
            <IoChatbubbleEllipsesOutline className="text-lg text-pink-500"/>
          </div>
          <h1 className="font-bold text-xl">Live chat</h1>
          <p className="text-gray-500 text-sm">Chat with our support team</p>
          <Button className="bg-white text-pink-500 font-semibold">Start chat</Button>
